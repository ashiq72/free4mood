export const ActionButton = ({ icon: Icon, label }: any) => (
  <button className="flex-1 flex items-center justify-center gap-2 py-2 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition-colors group cursor-pointer">
